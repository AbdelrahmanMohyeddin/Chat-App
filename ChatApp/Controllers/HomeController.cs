...
namespace ChatApp.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> CreatePrivateRoom(string userId)
        {
            ...
            var currId = User.FindFirst(ClaimTypes.NameIdentifier).Value;
            ...
            var chatExist = _ctx.Chats.FirstOrDefault(
                c => c.Users.Any(u => u.UserId == userId) &&
                     c.Users.Any(u => u.UserId == currId)
                );

            if (chatExist != null)
            {
                return RedirectToAction("Chat", new { id = chatExist.Id });
            }
